...
const stripePromise =
  typeof window !== 'undefined' ? loadStripe(process.env.NEXT_PUBLIC_STRIPE_PUBLISHABLE_KEY) : null;
...
const PlanCard = ({
  ...
  <div
    className={`relative bg-white rounded-lg shadow-md p-6 ${isRecommended ? 'border-2 border-blue-500' : ''}`}
  >
    {isRecommended && (
      ...
      return (
        <div className='bg-gray-100 p-4 rounded-md mb-6'>
          <p className='text-center'>
            You are currently on the <span className='font-bold'>Free Plan</span>.
          </p>
      ...
      return (
        <div className='bg-blue-50 p-4 rounded-md mb-6 border border-blue-200'>
          <p className='text-center'>
            ...
            <span className='font-bold capitalize'>{currentPlanData} Plan</span>.
          </p>
          <p className='text-center text-sm text-gray-600 mt-1'>
          ...
          <div className='mt-2 text-center'>
            <p className='text-sm'>
              ...
              <span className='font-semibold'>{subscriptionData?.responseLimit || 0}</span>{' '}
      ...
      <div className='mt-16'>
        ...
        <div className='space-y-4'>
          ...
          <div className='bg-white rounded-md shadow-sm p-4'>
            ...
            <p className='text-gray-700 mt-1'>
              You&apos;ll be billed immediately upon subscribing, and then on the same date each
              month.
            </p>
          </div>
